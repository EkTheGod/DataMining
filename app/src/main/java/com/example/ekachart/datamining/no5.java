 ...
 */
public class no5 extends Activity {
    ...
    private void buttonClick() {
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent sentopage = new Intent(getBaseContext(), no6.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), no4.class);
                startActivity(i);
                finish();
            }
        });
