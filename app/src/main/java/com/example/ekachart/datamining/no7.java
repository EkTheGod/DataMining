 ...
 */
public class no7 extends Activity {
    private Button next,back;
    private String No1 ="",No2="",No3="",No4="",No5="",No6="",No7="";
    ...
    private void buttonClick() {
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent sentopage = new Intent(getBaseContext(), no8.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), no6.class);
                startActivity(i);
                finish();
            }
        });
